...
outmodel = writeCbModel(model, 'xls', 'iSB619_model.xls'); % write all reactions to xls file
modelClosed = model;
...
%
iSB619_1_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   % not the right value...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Pyruvate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_2_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   % not the right value...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% D-glucose
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_3_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   % not the right value...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Fumarate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_4_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Acetaldehyde
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_5_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 2-oxoglutarate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_6_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Ethanol
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_7_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Formate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_8_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% D-fructose
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_9_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L-glutamine
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_10_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L-glutamate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_11_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% D-lactate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_12_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L-malate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_13_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Succinate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iSB619_14_CUE = (Uptake_tmp - Secretion_tmp)/Uptake_tmp; 

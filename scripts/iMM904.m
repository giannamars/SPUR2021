...
%
iMM904_1_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   % not the right value...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Pyruvate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_2_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   % not the right value...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% D-glucose
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_3_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   % not the right value...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Fumarate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_4_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Acetaldehyde
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_5_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 2-oxoglutarate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_6_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Ethanol
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_7_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Formate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_8_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% D-fructose
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_9_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L-glutamine
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_10_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp;  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L-glutamate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_11_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% D-lactate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_12_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L-malate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_13_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Succinate
modelClosed = modelClosedOri;
modelClosed.lb(find(ismember(modelClosed.rxns, 'EX_o2_e'))) = -1000;
...
Secretion_tmp = abs(sum(Secretion_fluxes.*Secretion_atoms));
%
iMM904_14_C = (Uptake_tmp - Secretion_tmp)/Uptake_tmp; 
